-- Fix instant_buy_crypto function to ensure NGN is properly debited
-- Issue: NGN balance was not being debited correctly in some cases
-- This migration fixes the balance update logic and adds validation
...
-- Add comment
COMMENT ON FUNCTION public.instant_buy_crypto IS 'Instant buy crypto function. Swaps NGN to crypto instantly using system inventory. Updates user_wallets, wallet_balances, and system_wallets tables. FIXED: Added validation to ensure NGN balance is properly debited.';
