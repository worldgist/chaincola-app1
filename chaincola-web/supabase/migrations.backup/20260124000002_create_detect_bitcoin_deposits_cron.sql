-- Create cron job to detect Bitcoin deposits
-- Runs every 1 minute to check for new Bitcoin deposits and auto-convert to NGN
...
SELECT cron.schedule(
  ...
  SELECT
    net.http_post(
      url := 'https://slleojsdpctxhlsoyenr.supabase.co/functions/v1/detect-bitcoin-deposits',
...
COMMENT ON EXTENSION pg_cron IS 'Enables scheduled jobs for detecting Bitcoin deposits and auto-converting to NGN';
