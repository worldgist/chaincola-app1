-- Migration script to sync existing wallet_balances to user_wallets table
...
GRANT EXECUTE ON FUNCTION public.sync_user_wallet_from_balances(UUID) TO service_role;
