...
DROP POLICY IF EXISTS "Admins can view inventory adjustments" ON public.inventory_adjustments;
...
DROP POLICY IF EXISTS "Service role can manage inventory adjustments" ON public.inventory_adjustments;
...
DROP POLICY IF EXISTS "Admins can view reconciliation history" ON public.reconciliation_history;
...
DROP POLICY IF EXISTS "Service role can manage reconciliation history" ON public.reconciliation_history;
...
-- ============================================================================
-- 4. CREATE treasury_reconciliation_status TABLE (IF NOT EXISTS)
-- ============================================================================
...
DROP POLICY IF EXISTS "Admins can view reconciliation status" ON public.treasury_reconciliation_status;
...
DROP POLICY IF EXISTS "Service role can manage reconciliation status" ON public.treasury_reconciliation_status;
...
-- ============================================================================
-- 5. ENHANCED RECONCILIATION STATUS WITH FREEZE FLAG
-- ============================================================================
...
-- ============================================================================
-- 7. FUNCTION: CONFIRM PENDING ADJUSTMENT
-- ============================================================================
...
-- ============================================================================
-- 9. FUNCTION: RESOLVE DISCREPANCY
-- ============================================================================
...
COMMENT ON FUNCTION public.force_reconciliation(TEXT, TEXT, UUID, TEXT, TEXT) IS 'Manually triggers reconciliation for an asset, fetching on-chain balance and comparing with ledger';
