-- Add treasury audit logging to swap_crypto function
-- This migration adds comprehensive audit logging for swap operations to the treasury system
...
COMMENT ON FUNCTION public.swap_crypto IS 'Swap one cryptocurrency for another in a single atomic transaction. Uses sell price for from_asset and buy price for to_asset. Includes comprehensive treasury audit logging.';
