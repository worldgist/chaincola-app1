-- QUICK FIX: Update instant_sell_crypto_v2 to also update wallet_balances table
-- This ensures NGN balance shows up in the app after selling crypto
...
BEGIN
  ...
  BEGIN
    ...
    -- CRITICAL FIX: Also update wallet_balances table (app reads from here!)
    ...
    -- Update NGN balance in wallet_balances (THIS IS WHAT WAS MISSING!)
    INSERT INTO public.wallet_balances (user_id, currency, balance, updated_at)
